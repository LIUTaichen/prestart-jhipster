...
import { PrestartCheckQuestionListItemUpdateComponent } from 'app/entities/prestart-check-question-list-item/prestart-check-question-list-item-update.component';
...
describe('Component Tests', () => {
    describe('PrestartCheckQuestionListItem Management Update Component', () => {
        let comp: PrestartCheckQuestionListItemUpdateComponent;
        let fixture: ComponentFixture<PrestartCheckQuestionListItemUpdateComponent>;
        let service: PrestartCheckQuestionListItemService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [PrestartTestModule],
                declarations: [PrestartCheckQuestionListItemUpdateComponent]
            })
                .overrideTemplate(PrestartCheckQuestionListItemUpdateComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(PrestartCheckQuestionListItemUpdateComponent);
