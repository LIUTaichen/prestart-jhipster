    ...
    describe('EmailSubscription Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a EmailSubscription', () => {
                service.create(new EmailSubscription(null)).subscribe(received => {
            ...
            it('should update a EmailSubscription', () => {
                service.update(new EmailSubscription(123)).subscribe(received => {
            ...
            it('should return a EmailSubscription', () => {
            ...
            it('should return a list of EmailSubscription', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new EmailSubscription(123)]);
            });
